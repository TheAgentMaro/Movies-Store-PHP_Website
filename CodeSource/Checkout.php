<?php
  ...
  if(isset($_GET["action"])){  
    if($_GET["action"] == "delete"){  
      $CartShop->RemoveFromCart();
    }  
  }  

if(isset($_POST['checkoutBtn'])){
  $CartShop->SubmitOrder();
}
      ...
      <section class="fonts">
          ...
          <div><br /><br />
              <form id="formDelivery" method="post" action="">
                  <table width="30%" height="370px" bgcolor="#3D2683" align="center" class="mainTable" style="max-width: 600px;">
                      <tr>
              ...
              <div>  
                   <table class="showTable">  
                        ...
                        <tr>  
                             ...
                             <td><a href="Checkout.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span style="color: #3D2683;">Remove</span></a></td>  
                        </tr>  
                        <?php  
