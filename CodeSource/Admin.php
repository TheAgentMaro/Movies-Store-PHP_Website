<?php
  ...
  if(isset($_POST['submitInsertion'])){
    $Dashboard->submitInsertion();     
  }

  if(isset($_POST['submitUpdate'])){
    $Dashboard->UpdateMovieStock($_POST['stock_quantity']);       
  }
...
<body>
     <div class="flex max-grid">
        ...
        <section class="fonts">
                ...
                <table width="70%" height="730px" bgcolor="#3D2683" align="center" class="mainTable">
                    <tr>
                        ...
                        <td>
                            ...
                            <tr>
                              ...
                              <td align="center">
                                <!-- top tiles -->
                                 <div class="DashboardLine">                                     
                                    ...
                                    <span class="DashoboardSpan">
                                      <?php
                                            echo $Dashboard ->getFemalesCount();
                                      ?>                                             
                                    </span>
                                  </div>
                              </td> 
                              ...
                              <td align="center">
                                ...
                                <span class="DashoboardSpan">
                                  <?php
                                        echo $Dashboard ->getReviewsCount();
                                  ?>                                             
                                </span>
                              </td>
                            </tr>
                                  ...
                                  <tr>
                                    ...
                                    <td style="padding: 30px; vertical-align: top;">
                                      <button class="accordion">
                                        <h2 class="headerDashboard">
                                          <div class='bootstrap-iso' style='display: unset;'>
                                            <span style='background: #3D2683;' class='badge badge-pill badge-danger tableCount'>
                                              <?php
                                                echo "#", $Dashboard ->getOrdersCount();
                                              ?>
                                            </span>
                                          </div>Orders Board
                                        </h2>
                                      ...
                                      <div class="panel">
                                        <?php
                                          echo $Dashboard ->DashboardOrdersBoardController();
                                        ?>
                                      </div>
                                    </td>   
                                      ...
                                      <tr>                                  
                                        ...
                                        <td align="center">
                                            <label for="file-upload" class="custom-file-upload">
                                                <i class="fa fa-cloud-upload"></i> Choose a cover<br><i style="color: lightblue">must be in .../assets/</i>
                                            </label>
                              ...
                              <td  style="padding: 30px; vertical-align: top;">
                                      <button class="accordion">
                                        <h2 class="headerDashboard">
                                          <div class='bootstrap-iso' style='display: unset;'>
                                            <span style='background: #3D2683;' class='badge badge-pill badge-danger tableCount'>
                                              <?php
                                                echo "#", $Dashboard ->getProductsCount();
                                              ?>
                                            </span>
                                          </div>Products Board
                                        </h2>
                                      ...
                                      <div class="panel">
                                        <?php
                                          echo $Dashboard ->DashboardProductsBoardController();
                                        ?>
                                      </div>
                                    </td> 
